...
public class DefaultUserServiceImpl implements DefaultUserService{
	...
	static final String Account_Sid = "AC35cf385a8e78c420f18e71d977bdc0c4";
	static final String Auth_Token = "76c4b3698a143144f2d19a13f8e48149";
   ...
   @Autowired
	...
	public String genrateOTPAndSendOnMobile(User userdata) {
		...
		Message message = Message.creator(new PhoneNumber("+91"+userdata.getMobileNo()), new PhoneNumber("+15075644529"), "This is the OTP sent for verification"+" "+ otp+ ".Please verify!")
                .create();
